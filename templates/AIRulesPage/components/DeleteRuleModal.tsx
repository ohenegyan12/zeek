...
const DeleteRuleModal = ({ onClose, onDelete }: Props) => {
    return (
        <div className="text-center">
            ...
            <div className="mb-2 text-h4 max-md:text-h5">Delete Rule</div>
            <div className="mb-8 text-body-lg text-gray-500 max-md:mb-5 max-md:text-body-md">
                Are you sure you want to delete this rule? Doing so may affect AI behavior.
            </div>
